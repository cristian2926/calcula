...
class MainActivity : AppCompatActivity() {
    ...
    fun buttonSetup(){
        var listaB= arrayOf(R.id.btn9, R.id.btn8, R.id.btn7, R.id.btn6, R.id.btn5, R.id.btn4,
            R.id.btn3, R.id.btn2, R.id.btn1, R.id.btn0, R.id.btnMas, R.id.btnIgual, R.id.btnMenos, R.id.btnMult)
